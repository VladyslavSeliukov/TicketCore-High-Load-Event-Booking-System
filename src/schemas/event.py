...
class EventCreate(BaseModel):
    ...
    country: str = Field(..., min_length = 1, description='Country of the event', examples=['Poland'])
    city: str = Field(..., min_length = 1, description='City of the event', examples=['Wroclaw'])
    street_address: str = Field(..., min_length = 1, description='Street address of the event', examples=['Sucha 1'])
...
class EventUpdate(EventCreate):
    ...
    country: str = Field(None, min_length = 1, description='Country of the event', examples=['Poland'])
    city: str = Field(None, min_length = 1, description='City of the event', examples=['Wroclaw'])
    street_address: str = Field(None, min_length = 1, description='Street address of the event', examples=['Sucha 1'])